...
import { rpcUrls, chainIdHexes } from "../../config";
  ...
  return (
    <React.Fragment>
      <ElevationScroll {...props} px={"10px !important"} class>
        <AppBar height={{ xs: "100px", sm: "60px" }}>
          <Toolbar px={"0px"} height={{ xs: "100px", sm: "60px" }}>
            <Box
              position={`fixed`}
              style={{
                ...
                >
                  ...
                  >
                    <IoPersonOutline
                      size={22}
                      cursor={"pointer"}
                      color={theme === "dark-theme" ? "#fff" : "#585858"}
                    />
                  </Box>
                  <Box
                    sx={{
                  ...
                  >
                    <img
                      src={
                        theme == "dark-theme" ? darkSunImage : yellowSunImage
                      }
                      width={"22px"}
                      height={"22px"}
                    />
